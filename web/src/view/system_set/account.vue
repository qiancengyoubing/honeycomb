<template>
	...
	<div>
      ...
      <Form ref="filterFormRef" :model="filterFormModel" :label-width="80">
				<FormItem label="账户名称" style="width:15%">
					<Input v-model="filterFormModel.usage" placeholder="Enter something..."></Input>
				</FormItem>
				<FormItem label="账户类型" style="width:15%">
					<Select v-model="filterFormModel.usage">
						<Option value="0">请选择</Option>
						<Option value="1">全部</Option>
						<Option value="2">对公</Option>
						<Option value="3">对私</Option>
						<Option value="4">微信</Option>
						<Option value="5">支付宝</Option>
					</Select>
				</FormItem>
				<FormItem label="部门" style="width:15%">
					<Input v-model="filterFormModel.usage" placeholder="Enter something..."></Input>
				</FormItem>
				<FormItem label="开户行" style="width:15%">
					<Input v-model="filterFormModel.usage" placeholder="Enter something..."></Input>
				</FormItem>
				<FormItem label="账号" style="width:15%">
					<Input v-model="filterFormModel.usage" placeholder="Enter something..."></Input>
				</FormItem>
		...
		<Row>
			<div class="table_action" @click="$router.push({name:'account_newOrEdit'})">
				<Button  type="primary">添加</Button>
			</div>
			<div class="table_action" @click="">
